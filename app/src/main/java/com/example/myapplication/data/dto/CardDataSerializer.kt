...
//
//object CardDataSerializer: KSerializer<CardData> {
//
//    override val descriptor: SerialDescriptor = buildClassSerialDescriptor(
//        CardData::class.simpleName!!
//    ) {
//        element<String?>("description")
//    }
//
//    override fun deserialize(decoder: Decoder): CardData = decoder.decodeStructure(descriptor) {
...
//        }
//
//        return@decodeStructure CardData()
//    }
//
//    override fun serialize(encoder: Encoder, value: CardData) = encoder.encodeStructure(
//        descriptor
//    ) {
